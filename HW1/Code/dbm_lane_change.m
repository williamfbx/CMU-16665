...
u1 = zeros(1, round(5/(tstep * 30)));
u2 = atan(5/90) * ones(1, round(90/(tstep * 30)));
u3 = zeros(1, round(5/(tstep * 30)));

% Additional tradjectory to examine error and settling time
u4 = zeros(1, round(50/(tstep * 30))); 

psi_des = [u1 u2 u3 u4];
psidot_des = gradient(psi_des, tstep);
